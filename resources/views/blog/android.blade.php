        ...
        <header class="py-5 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    ...
                    <p class="lead mb-0">Esta es la seccion de noticias de Android</p>
                </div>
            </div>
        </header>
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="small text-muted">Enero 12 2022</div>
                            <h2 class="card-title">Yu-Gi-Oh! Duel links celebra su quinto aniversario.</h2>
