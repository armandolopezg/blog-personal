            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <figure class="mb-4"><img class="img-fluid rounded" src="/img/blackwind.png" alt="..." /></figure>
                      
                        <section class="mb-5">
                            <p class="fs-5 mb-4">{{$post->contenido_publicacion}}</p>
                            <p class="fs-5 mb-4">{{$post->contenido_publicacion2}}</p>

                            <figure class="mb-4"><img class="img-fluid rounded" src="/img/1.png" alt="..." /></figure>
                            <figure class="mb-4"><img class="img-fluid rounded" src="/img/2.png" alt="..." /></figure>
                            <figure class="mb-4"><img class="img-fluid rounded" src="/img/3.jpg" alt="..." /></figure>

                            <p class="fs-5 mb-4">{{$post->contenido_publicacion3}}</p>
                            <iframe width="800" height="600" src="https://www.youtube.com/embed/bcLZJrVDMhE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </section>
                    </article>
                    </div>
                </div>
